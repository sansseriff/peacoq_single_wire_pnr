...
from SocketClient import SocketClient  # for attenuator controll
...
class AttenuationAndIntegrate(Action):
...
class ValueIntegrateHistogram(Action):
    ...
    def evaluate(self, current_time, counts, **kwargs):
        ...
        if np.sum(self.counts) > self.min_counts:
            # finish up
